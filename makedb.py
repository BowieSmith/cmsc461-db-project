...
if conn is not None:
	...
	sql_cr_gsa_office = """CREATE TABLE IF NOT EXISTS gsa_office (
		office_name text PRIMARY KEY,
		office_city text,
		sqft_managed real);"""

	sql_cr_customer_agency = """CREATE TABLE IF NOT EXISTS customer_agency ( 
	...
	sql_cr_rental_agreements = """CREATE TABLE IF NOT EXISTS rental_agreements (
	...
	sql_cr_agency_rental_agreements = """CREATE TABLE IF NOT EXISTS agency_rental_agreements (
		agency_id text,
		ra_id text,
